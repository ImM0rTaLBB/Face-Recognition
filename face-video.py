...
cap = cv2.VideoCapture('C:\\Users\\Nik\\Desktop\\Python Proj\\facerecog\\src\\cascades\\video-trainset\\t2.mp4')
...
while(True):
    ...
    for (x,y,w,h) in faces:
        ...
        #img_item = "C:\\Users\\Nik\\Desktop\\Python Proj\\facerecog\\src\\cascades\\images\\apisit-srt\\"        #File path for new image captured to be placed
        #type_file = ".png"
